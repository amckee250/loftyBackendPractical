    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_img_url', models.URLField(unique=True)),
                ('original_img', models.ImageField(upload_to='dog_images')),
                ('modified_img', models.ImageField(null=True, upload_to='dog_images')),
