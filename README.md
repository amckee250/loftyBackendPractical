...
docker compose up
```
Note: I have found it can take some time for PostGresSQL to setup and be ready for use. If an error occurs, re-attempt docker compose up command before continuing
